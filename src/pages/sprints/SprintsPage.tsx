  ...
  return (
    <div className="min-h-full flex flex-col bg-background p-4 md:p-6 lg:p-8 animate-in fade-in duration-300 relative">
      <div className="max-w-[1600px] mx-auto w-full space-y-8 animate-in fade-in duration-500 pb-20">
          ...
          {sprints.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-24 bg-card/10 rounded-xl border-2 border-dashed border-border/40">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Haga clic en 'Lanzar Planificación' para comenzar un nuevo
                ciclo.
              </p>
        ...
        <ConfirmDialog
          open={showForceCompleteConfirm}
          onOpenChange={(open) => {
            setShowForceCompleteConfirm(open);
          }}
          title="¿Cerrar sprint con tareas pendientes?"
          description="Hay tareas que no se completaron. En Scrum, estas tareas deben regresar al backlog manualmente. ¿Deseas cerrar el sprint de todas formas?"
