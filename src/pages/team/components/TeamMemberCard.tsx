    ...
    >
      ...
      <div className="p-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-7 w-7 rounded-md opacity-40 group-hover:opacity-100 transition-opacity"
              >
            ...
            <DropdownMenuContent
              align="end"
              className="w-44 rounded-xl p-1.5 backdrop-blur-xl bg-popover/90 border-border/40 shadow-2xl"
            >
              <DropdownMenuItem
                onClick={() => {
                  onEdit(member);
                }}
                className="rounded-lg gap-2 font-semibold py-2 text-xs text-foreground/70"
              >
              ...
              <DropdownMenuItem
                ...
                className="rounded-lg gap-2 font-semibold py-2 text-xs text-rose-500 hover:text-rose-600 hover:bg-rose-500/10 focus:bg-rose-500/10 focus:text-rose-600"
              >
        ...
        <div className="space-y-0.5 min-w-0">
          <h3 className="text-sm font-semibold tracking-tight text-foreground/90 truncate">
            {member.name}
          </h3>
        ...
        <div className="mt-4 pt-3 border-t border-border/10 flex items-center justify-between">
          <Badge
            variant="secondary"
            className={cn(
              "rounded-md px-2 py-0.5 font-semibold text-xs border-none flex items-center gap-1",
              config.bg,
              config.color,
            )}
          >
