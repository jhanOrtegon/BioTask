...
export function useEpicsLogic() {
 ...
 title: epic.title,
 steps: [
 { title: 'Re-balanceo', desc: `Movilizar recursos para apoyar "${epic.title}".` },
 { title: 'Análisis', desc: 'Identificar factores de retraso.' },
 { title: 'Check-in', desc: 'Reunión rápida con leads.' }
 ]
 }
 ...
 form, setForm,
 actionPlanEpicId, setActionPlanEpicId,
 actionPlanData,
 openCreate,
 handleSave,
 navigate
