...
interface StoriesState {
 ...
 updateStory: (id: string, data: Partial<Pick<Story, 'code' | 'title' | 'module' | 'description' | 'epicId' | 'isBlocked'>>, comment: string) => void
 ...
 updateTask: (storyId: string, taskId: string, data: Partial<Pick<TrackedTask, 'title' | 'type' | 'featureName' | 'screenPath' | 'data' | 'jiraContent' | 'status' | 'estimatedHours' | 'sprintId' | 'priority' | 'dueDate' | 'checklists' | 'position' | 'isBlocked'>>, comment: string) => void
