  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4 border-t pt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-center space-x-2 border p-3 rounded-lg hover:bg-muted/50 cursor-pointer">
            ...
            />
            <Label htmlFor="hasObjective" className="cursor-pointer">Objetivo de la Tarea</Label>
          </div>
          ...
          <div className="flex items-center space-x-2 border p-3 rounded-lg hover:bg-muted/50 cursor-pointer">
            ...
            />
            <Label htmlFor="hasServices" className="cursor-pointer">Sección de Servicios (API/Payload)</Label>
          </div>
          ...
          <div className="flex items-center space-x-2 border p-3 rounded-lg hover:bg-muted/50 cursor-pointer">
            ...
            />
            <Label htmlFor="hasFunctionalRequirements" className="cursor-pointer">Requerimientos Funcionales</Label>
          </div>
          ...
          <div className="flex items-center space-x-2 border p-3 rounded-lg hover:bg-muted/50 cursor-pointer">
            ...
            />
            <Label htmlFor="hasValidations" className="cursor-pointer">Sección de Validaciones</Label>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-3 pt-4 border-t">
        ...
        <Button type="submit">Guardar Configuración de Molde</Button>
      </div>
    </form>
  )
}
