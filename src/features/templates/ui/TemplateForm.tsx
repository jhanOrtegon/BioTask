        ...
        <div className="space-y-4 border-t pt-6">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <Label className="text-base font-black tracking-tight flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className={`p-4 rounded-2xl border transition-all ${formData.hasObjective ? 'bg-primary/5 border-primary/20 shadow-sm' : 'bg-muted/10 border-border opacity-60'}`}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                  <div className="flex items-center space-x-2">
                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Visible</span>
                    <Checkbox 
                      id="hasObjective" 
                      disabled={readOnly}
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className={`text-[10px] font-bold uppercase tracking-widest ${formData.requiredObjective ? 'text-amber-600' : 'text-muted-foreground'}`}>Obligatorio</span>
                        </TooltipTrigger>
            ...
            <div className={`p-4 rounded-2xl border transition-all ${formData.hasServices ? 'bg-blue-500/5 border-blue-500/20 shadow-sm' : 'bg-muted/10 border-border opacity-60'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-lg bg-background border flex items-center justify-center">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-[10px] font-bold uppercase tracking-widest ${formData.requiredServices ? 'text-amber-600' : 'text-muted-foreground'}`}>Obligatorio</span>
                    <Checkbox 
                      id="requiredServices" 
            ...
            <div className={`p-4 rounded-2xl border transition-all ${formData.hasFunctionalRequirements ? 'bg-emerald-500/5 border-emerald-500/20 shadow-sm' : 'bg-muted/10 border-border opacity-60'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-lg bg-background border flex items-center justify-center">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-[10px] font-bold uppercase tracking-widest ${formData.requiredRequirements ? 'text-amber-600' : 'text-muted-foreground'}`}>Obligatorio</span>
                    <Checkbox 
            ...
            <div className={`p-4 rounded-2xl border transition-all ${formData.hasValidations ? 'bg-purple-500/5 border-purple-500/20 shadow-sm' : 'bg-muted/10 border-border opacity-60'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-lg bg-background border flex items-center justify-center">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-[10px] font-bold uppercase tracking-widest ${formData.requiredValidations ? 'text-amber-600' : 'text-muted-foreground'}`}>Obligatorio</span>
                    <Checkbox 
