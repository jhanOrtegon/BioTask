...
const EXPORT_KEYS = [
 ...
 'stories-storage',
 'tasks-storage',
 'sprints-storage' // preparing for new feature
]
...
export function DataBackup() {
 ...
 data.state.stories = data.state.stories.map((story) => ({
 ...story,
 ...
 const parsedData = JSON.parse(result) as BackupData
 ...
 console.error(error)
 toast.error('Error importando el respaldo', { description: 'Asegúrate de que sea un archivo JSON exportado por BioTask validamente.' })
 }
 ...
 <DropdownMenuLabel className="font-bold text-xs text-muted-foreground">Datos Locales</DropdownMenuLabel>
 <DropdownMenuSeparator />
