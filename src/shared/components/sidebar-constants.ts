...
export const navSections: { title: string; items: NavItem[] }[] = [
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: "Dinámica de Carga",
            path: "/analytics/load",
            icon: TrendingUp,
          },
          {
            label: "Telemetría de Velocidad",
  ...
  },
  {
    title: "GESTIÓN",
    items: [
      { icon: Building2, label: "Equipos por Módulo", path: "/teams" },
