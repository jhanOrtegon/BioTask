...
export function CommentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md border-border bg-popover shadow-2xl rounded-2xl">
        ...
        <div className="space-y-2 py-2">
          <Label htmlFor="audit-comment" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
